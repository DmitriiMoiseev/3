...
export class ProductService {
  ...
  private products: {
    [key: number]: Product } = {
    1: new Product(1, 'First product', 100),
    2: new Product(2, 'Second product', 200),
    3: new Product(3, 'Third product', 300),
    4: new Product(4, 'Fourth product', 400),
    5: new Product(5, 'Fifth product', 500),
